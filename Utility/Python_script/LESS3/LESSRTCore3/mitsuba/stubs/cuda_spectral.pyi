...
class AdjointIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.cuda_spectral.AdjointIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...

    def aov_names(self: mitsuba.cuda_spectral.Integrator) -> List[str]:
        """
    ...
    def cancel(self: mitsuba.cuda_spectral.Integrator) -> None:
        """
    ...
    @overload
    def render(self: mitsuba.cuda_spectral.Integrator, scene: mitsuba.cuda_spectral.Scene, sensor, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render(self: mitsuba.cuda_spectral.Integrator, scene: mitsuba.cuda_spectral.Scene, sensor: int = 0, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> mitsuba.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render_backward(self: mitsuba.cuda_spectral.AdjointIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.cuda_spectral.AdjointIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.cuda_spectral.AdjointIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.cuda_spectral.AdjointIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    def sample(self: mitsuba.cuda_spectral.AdjointIntegrator, scene: mitsuba.cuda_spectral.Scene, sensor, sampler, block: mitsuba.cuda_spectral.ImageBlock, sample_scale: float) -> None:
        """
    ...
    def should_stop(self: mitsuba.cuda_spectral.Integrator) -> bool:
        """
...
class BSDF(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.BSDF, props: mitsuba.Properties) -> None: ...
    m_components = ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.cuda_spectral.BSDF, active: mitsuba.Bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_attribute(self: mitsuba.cuda_spectral.BSDF, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_attribute_1(self: mitsuba.cuda_spectral.BSDF, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_attribute_3(self: mitsuba.cuda_spectral.BSDF, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
        """
    ...
    def eval_diffuse_reflectance(self: mitsuba.cuda_spectral.BSDF, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_null_transmission(self: mitsuba.cuda_spectral.BSDF, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_pdf(self: mitsuba.cuda_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
    ...
    def eval_pdf_sample(self: mitsuba.cuda_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float, mitsuba.cuda_spectral.BSDFSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    @overload
    def flags(self: mitsuba.cuda_spectral.BSDF, index: int, active: mitsuba.Bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_spectral.BSDF) -> int:
        """
        Flags for all components combined.
        """
        ...

    def has_attribute(self: mitsuba.cuda_spectral.BSDF, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def id(self: mitsuba.cuda_spectral.BSDF) -> str:
        """
    ...
    def needs_differentials(self: mitsuba.cuda_spectral.BSDF) -> bool:
        """
    ...
    def pdf(self: mitsuba.cuda_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.BSDFSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
...
class BSDFPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.BSDFPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BSDFPtr, arg0: mitsuba.cuda_spectral.BSDF) -> None: ...
    class BSDF(Object):
        """
        Bidirectional Scattering Distribution Function (BSDF) interface
    ...
    def assign(self: mitsuba.cuda_spectral.BSDFPtr, arg0: mitsuba.cuda_spectral.BSDFPtr) -> None: ...
    def eval(self: mitsuba.cuda_spectral.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Evaluate the BSDF f(wi, wo) or its adjoint version f^{*}(wi, wo) and
        multiply by the cosine foreshortening term.
    ...
    def eval_attribute(self: mitsuba.cuda_spectral.BSDFPtr, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Evaluate a specific BSDF attribute at the given surface interaction.
    ...
    def eval_attribute_1(self: mitsuba.cuda_spectral.BSDFPtr, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Monochromatic evaluation of a BSDF attribute at the given surface
        interaction
    ...
    def eval_attribute_3(self: mitsuba.cuda_spectral.BSDFPtr, name: str, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
        """
        Trichromatic evaluation of a BSDF attribute at the given surface
        interaction
    ...
    def eval_diffuse_reflectance(self: mitsuba.cuda_spectral.BSDFPtr, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Evaluate the diffuse reflectance
    ...
    def eval_null_transmission(self: mitsuba.cuda_spectral.BSDFPtr, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Evaluate un-scattered transmission component of the BSDF
    ...
    def eval_pdf(self: mitsuba.cuda_spectral.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def eval_pdf_sample(self: mitsuba.cuda_spectral.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float, mitsuba.cuda_spectral.BSDFSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def flags(self: mitsuba.cuda_spectral.BSDFPtr) -> mitsuba.UInt:
        """
        Flags for all components combined.
        """
        ...

    def has_attribute(self: mitsuba.cuda_spectral.BSDFPtr, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Returns whether this BSDF contains the specified attribute.
    ...
    def needs_differentials(self: mitsuba.cuda_spectral.BSDFPtr) -> mitsuba.Bool:
        """
        Does the implementation require access to texture-space differentials?
        """
        ...

    def pdf(self: mitsuba.cuda_spectral.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Compute the probability per unit solid angle of sampling a given
        direction
    ...
    def sample(self: mitsuba.cuda_spectral.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_spectral.SurfaceInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.BSDFSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample the BSDF model
...
class BSDFSample3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BSDFSample3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BSDFSample3f, wo: mitsuba.cuda_spectral.Vector3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BSDFSample3f, bs: mitsuba.cuda_spectral.BSDFSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.BSDFSample3f, arg0: mitsuba.cuda_spectral.BSDFSample3f) -> None: ...
    ...
...
class Bool:
    ...
    @overload
    def __init__(self: mitsuba.Bool, arg0) -> None: ...
    @overload
...
class BoundingBox2f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox2f, p: mitsuba.cuda_spectral.Point2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox2f, min: mitsuba.cuda_spectral.Point2f, max: mitsuba.cuda_spectral.Point2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.BoundingBox2f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def center(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.cuda_spectral.Point2f:
        """
        Return the center point
        """
        ...

    def clip(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.BoundingBox2f) -> None:
        """
        Clip this bounding box to another bounding box
        """
        ...

    def collapsed(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_spectral.BoundingBox2f, p: mitsuba.cuda_spectral.Point2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_spectral.BoundingBox2f, bbox: mitsuba.cuda_spectral.BoundingBox2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    def corner(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: int) -> mitsuba.cuda_spectral.Point2f:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.Point2f) -> mitsuba.Float:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.Point2f) -> None:
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.BoundingBox2f) -> None:
        """
        Expand the bounding box to contain another bounding box
        """
        ...

    def extents(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.cuda_spectral.Vector2f:
        """
    ...
    def major_axis(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_spectral.BoundingBox2f, bbox: mitsuba.cuda_spectral.BoundingBox2f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    def reset(self: mitsuba.cuda_spectral.BoundingBox2f) -> None:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.Point2f) -> mitsuba.Float:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_spectral.BoundingBox2f, arg0: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
    ...
    def surface_area(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Bool:
        """
    ...
    def volume(self: mitsuba.cuda_spectral.BoundingBox2f) -> mitsuba.Float:
        """
...
class BoundingBox3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox3f) -> None:
        """
        Create a new invalid bounding box
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox3f, p: mitsuba.cuda_spectral.Point3f) -> None:
        """
        Create a collapsed bounding box from a single point
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox3f, min: mitsuba.cuda_spectral.Point3f, max: mitsuba.cuda_spectral.Point3f) -> None:
        """
        Create a bounding box from two positions
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.BoundingBox3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def bounding_sphere(self: mitsuba.cuda_spectral.BoundingBox3f):
        """
        Create a bounding sphere, which contains the axis-aligned box
        """
        ...

    def center(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.cuda_spectral.Point3f:
        """
        Return the center point
        """
        ...

    def clip(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.BoundingBox3f) -> None:
        """
        Clip this bounding box to another bounding box
        """
        ...

    def collapsed(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Bool:
        """
        Check whether this bounding box has collapsed to a point, line, or
        plane
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_spectral.BoundingBox3f, p: mitsuba.cuda_spectral.Point3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check whether a point lies *on* or *inside* the bounding box
    ...
    @overload
    def contains(self: mitsuba.cuda_spectral.BoundingBox3f, bbox: mitsuba.cuda_spectral.BoundingBox3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check whether a specified bounding box lies *on* or *within* the
        current bounding box
    ...
    def corner(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: int) -> mitsuba.cuda_spectral.Point3f:
        """
        Return the position of a bounding box corner
        """
        ...
    ...
    @overload
    def distance(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.Point3f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and the point ``p``.
    ...
    @overload
    def distance(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.Point3f) -> None:
        """
        Expand the bounding box to contain another point
    ...
    @overload
    def expand(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.BoundingBox3f) -> None:
        """
        Expand the bounding box to contain another bounding box
        """
        ...

    def extents(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Calculate the bounding box extents
    ...
    def major_axis(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_spectral.BoundingBox3f, bbox: mitsuba.cuda_spectral.BoundingBox3f, strict: bool = False) -> mitsuba.Bool:
        """
        Check two axis-aligned bounding boxes for possible overlap.
    ...
    def ray_intersect(self: mitsuba.cuda_spectral.BoundingBox3f, ray: mitsuba.cuda_spectral.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
    ...
    def reset(self: mitsuba.cuda_spectral.BoundingBox3f) -> None:
        """
        Mark the bounding box as invalid.
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.Point3f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and the point ``p``.
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_spectral.BoundingBox3f, arg0: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and ``bbox``.
        """
    ...
    def surface_area(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Bool:
        """
        Check whether this is a valid bounding box
    ...
    def volume(self: mitsuba.cuda_spectral.BoundingBox3f) -> mitsuba.Float:
        """
        Calculate the n-dimensional volume of the bounding box
        """
        ...
...
class BoundingSphere3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingSphere3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingSphere3f, arg0: mitsuba.cuda_spectral.Point3f, arg1: mitsuba.Float) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.BoundingSphere3f, arg0: mitsuba.cuda_spectral.BoundingSphere3f) -> None: ...
    center = ...
    radius = ...

    def contains(self: mitsuba.cuda_spectral.BoundingSphere3f, p: mitsuba.cuda_spectral.Point3f, strict: bool = False) -> mitsuba.Bool:
        """
    ...
    def empty(self: mitsuba.cuda_spectral.BoundingSphere3f) -> mitsuba.Bool:
        """
        Return whether this bounding sphere has a radius of zero or less.
        """
        ...

    def expand(self: mitsuba.cuda_spectral.BoundingSphere3f, arg0: mitsuba.cuda_spectral.Point3f) -> None:
        """
        Expand the bounding sphere radius to contain another point.
        """
        ...

    def ray_intersect(self: mitsuba.cuda_spectral.BoundingSphere3f, ray: mitsuba.cuda_spectral.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
        Check if a ray intersects a bounding box
        """
        ...
...
class ChainTransform3d(Transform3d):
    ...
    def assign(self: mitsuba.cuda_spectral.Transform3d, arg0: mitsuba.cuda_spectral.Transform3d) -> None: ...
    @overload
    def has_scale(self: mitsuba.cuda_spectral.Transform3d) -> mitsuba.Bool:
        """
    ...
    def inverse(self: mitsuba.cuda_spectral.Transform3d) -> mitsuba.cuda_spectral.Transform3d:
        """
    ...
    def rotate(self: mitsuba.cuda_spectral.ChainTransform3d, angle: mitsuba.Float64) -> mitsuba.cuda_spectral.ChainTransform3d:
        """
    ...
    def scale(self: mitsuba.cuda_spectral.ChainTransform3d, v: mitsuba.cuda_spectral.Point2d) -> mitsuba.cuda_spectral.ChainTransform3d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform3d, p: mitsuba.cuda_spectral.Point2d) -> mitsuba.cuda_spectral.Point2d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform3d, v: mitsuba.cuda_spectral.Vector2d) -> mitsuba.cuda_spectral.Vector2d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_spectral.ChainTransform3d, v: mitsuba.cuda_spectral.Point2d) -> mitsuba.cuda_spectral.ChainTransform3d:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_spectral.Transform3d) -> mitsuba.cuda_spectral.Vector2d:
        """
...
class ChainTransform3f(Transform3f):
    ...
    def assign(self: mitsuba.cuda_spectral.Transform3f, arg0: mitsuba.cuda_spectral.Transform3f) -> None: ...
    @overload
    def has_scale(self: mitsuba.cuda_spectral.Transform3f) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_spectral.Transform3f) -> mitsuba.cuda_spectral.Transform3f:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def rotate(self: mitsuba.cuda_spectral.ChainTransform3f, angle: mitsuba.Float) -> mitsuba.cuda_spectral.ChainTransform3f:
        """
        Create a rotation transformation in 2D. The angle is specified in
        degrees
        """
    ...
    def scale(self: mitsuba.cuda_spectral.ChainTransform3f, v: mitsuba.cuda_spectral.Point2f) -> mitsuba.cuda_spectral.ChainTransform3f:
        """
        Create a scale transformation
        """
        ...
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform3f, p: mitsuba.cuda_spectral.Point2f) -> mitsuba.cuda_spectral.Point2f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform3f, v: mitsuba.cuda_spectral.Vector2f) -> mitsuba.cuda_spectral.Vector2f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_spectral.ChainTransform3f, v: mitsuba.cuda_spectral.Point2f) -> mitsuba.cuda_spectral.ChainTransform3f:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_spectral.Transform3f) -> mitsuba.cuda_spectral.Vector2f:
        """
        Get the translation part of a matrix
        """
        ...
...
class ChainTransform4d(Transform4d):
    ...
    def assign(self: mitsuba.cuda_spectral.Transform4d, arg0: mitsuba.cuda_spectral.Transform4d) -> None: ...
    def extract(self: mitsuba.cuda_spectral.Transform4d) -> mitsuba.cuda_spectral.Transform3d:
        """
        Extract a lower-dimensional submatrix
        """
        ...

    def from_frame(self: mitsuba.cuda_spectral.ChainTransform4d, frame) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    @overload
    def has_scale(self: mitsuba.cuda_spectral.Transform4d) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_spectral.Transform4d) -> mitsuba.cuda_spectral.Transform4d:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def look_at(self: mitsuba.cuda_spectral.ChainTransform4d, origin: mitsuba.cuda_spectral.Point3d, target: mitsuba.cuda_spectral.Point3d, up: mitsuba.cuda_spectral.Point3d) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    def orthographic(self: mitsuba.cuda_spectral.ChainTransform4d, near: mitsuba.Float64, far: mitsuba.Float64) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    def perspective(self: mitsuba.cuda_spectral.ChainTransform4d, fov: mitsuba.Float64, near: mitsuba.Float64, far: mitsuba.Float64) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    def rotate(self: mitsuba.cuda_spectral.ChainTransform4d, axis: mitsuba.cuda_spectral.Point3d, angle: mitsuba.Float64) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    def scale(self: mitsuba.cuda_spectral.ChainTransform4d, v: mitsuba.cuda_spectral.Point3d) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
        Create a scale transformation
        """
        ...

    def to_frame(self: mitsuba.cuda_spectral.ChainTransform4d, frame) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4d, p: mitsuba.cuda_spectral.Point3d) -> mitsuba.cuda_spectral.Point3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4d, ray):
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4d, v: mitsuba.cuda_spectral.Vector3d) -> mitsuba.cuda_spectral.Vector3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4d, n: mitsuba.cuda_spectral.Normal3d) -> mitsuba.cuda_spectral.Normal3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_spectral.ChainTransform4d, v: mitsuba.cuda_spectral.Point3d) -> mitsuba.cuda_spectral.ChainTransform4d:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_spectral.Transform4d) -> mitsuba.cuda_spectral.Vector3d:
        """
        Get the translation part of a matrix
        """
        ...
...
class ChainTransform4f(Transform4f):
    ...
    def assign(self: mitsuba.cuda_spectral.Transform4f, arg0: mitsuba.cuda_spectral.Transform4f) -> None: ...
    def extract(self: mitsuba.cuda_spectral.Transform4f) -> mitsuba.cuda_spectral.Transform3f:
        """
        Extract a lower-dimensional submatrix
        """
        ...

    def from_frame(self: mitsuba.cuda_spectral.ChainTransform4f, frame: mitsuba.cuda_spectral.Frame3f) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Creates a transformation that converts from 'frame' to the standard
        basis
        """
    ...
    @overload
    def has_scale(self: mitsuba.cuda_spectral.Transform4f) -> mitsuba.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_spectral.Transform4f) -> mitsuba.cuda_spectral.Transform4f:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def look_at(self: mitsuba.cuda_spectral.ChainTransform4f, origin: mitsuba.cuda_spectral.Point3f, target: mitsuba.cuda_spectral.Point3f, up: mitsuba.cuda_spectral.Point3f) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create a look-at camera transformation
    ...
    def orthographic(self: mitsuba.cuda_spectral.ChainTransform4f, near: mitsuba.Float, far: mitsuba.Float) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create an orthographic transformation, which maps Z to [0,1] and
        leaves the X and Y coordinates untouched.
    ...
    def perspective(self: mitsuba.cuda_spectral.ChainTransform4f, fov: mitsuba.Float, near: mitsuba.Float, far: mitsuba.Float) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create a perspective transformation. (Maps [near, far] to [0, 1])
    ...
    def rotate(self: mitsuba.cuda_spectral.ChainTransform4f, axis: mitsuba.cuda_spectral.Point3f, angle: mitsuba.Float) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create a rotation transformation around an arbitrary axis in 3D. The
        angle is specified in degrees
        """
    ...
    def scale(self: mitsuba.cuda_spectral.ChainTransform4f, v: mitsuba.cuda_spectral.Point3f) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create a scale transformation
        """
        ...

    def to_frame(self: mitsuba.cuda_spectral.ChainTransform4f, frame: mitsuba.cuda_spectral.Frame3f) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Creates a transformation that converts from the standard basis to
        'frame'
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4f, p: mitsuba.cuda_spectral.Point3f) -> mitsuba.cuda_spectral.Point3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4f, ray: mitsuba.cuda_spectral.Ray3f) -> mitsuba.cuda_spectral.Ray3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_spectral.Transform4f, n: mitsuba.cuda_spectral.Normal3f) -> mitsuba.cuda_spectral.Normal3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_spectral.ChainTransform4f, v: mitsuba.cuda_spectral.Point3f) -> mitsuba.cuda_spectral.ChainTransform4f:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_spectral.Transform4f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Get the translation part of a matrix
        """
        ...
...
class Color0d:
    def __init__(self: mitsuba.cuda_spectral.Color0d, *args) -> None: ...
    label = ...
...
class Color0f:
    def __init__(self: mitsuba.cuda_spectral.Color0f, *args) -> None: ...
    label = ...
...
class Color1d:
    def __init__(self: mitsuba.cuda_spectral.Color1d, *args) -> None: ...
    label = ...
    x = ...
...
class Color1f:
    def __init__(self: mitsuba.cuda_spectral.Color1f, *args) -> None: ...
    label = ...
    x = ...
...
class Color3d:
    def __init__(self: mitsuba.cuda_spectral.Color3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Color3f:
    def __init__(self: mitsuba.cuda_spectral.Color3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class ContinuousDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of a regularly
        sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ContinuousDistribution, arg0: mitsuba.cuda_spectral.ContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ContinuousDistribution, range: mitsuba.Vector2f, pdf: mitsuba.Float) -> None:
        """
        Initialize from a given density function on the interval ``range``
        """
        ...

    def cdf(self: mitsuba.cuda_spectral.ContinuousDistribution) -> mitsuba.Float:
        """
    ...
    def empty(self: mitsuba.cuda_spectral.ContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_spectral.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_spectral.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_spectral.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_spectral.ContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def integral(self: mitsuba.cuda_spectral.ContinuousDistribution) -> mitsuba.Float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.cuda_spectral.ContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def max(self: mitsuba.cuda_spectral.ContinuousDistribution) -> float: ...
    def normalization(self: mitsuba.cuda_spectral.ContinuousDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_spectral.ContinuousDistribution) -> mitsuba.Float:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.cuda_spectral.ContinuousDistribution) -> mitsuba.Vector2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.cuda_spectral.ContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample_pdf(self: mitsuba.cuda_spectral.ContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.cuda_spectral.ContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.cuda_spectral.ContinuousDistribution) -> None:
        """
...
class CppADIntegrator(SamplingIntegrator):
    def __init__(self: mitsuba.cuda_spectral.CppADIntegrator, arg0: mitsuba.Properties) -> None: ...
    hide_emitters = ...
    ptr = ...
    ...
    @overload
    def render_backward(self: mitsuba.cuda_spectral.SamplingIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_backward(self: mitsuba.cuda_spectral.SamplingIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, grad_in: mitsuba.TensorXf, sensor: int = 0, seed: int = 0, spp: int = 0) -> None: ...
    @overload
    def render_forward(self: mitsuba.cuda_spectral.SamplingIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, sensor, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    @overload
    def render_forward(self: mitsuba.cuda_spectral.SamplingIntegrator, scene: mitsuba.cuda_spectral.Scene, params: object, sensor: int = 0, seed: int = 0, spp: int = 0) -> mitsuba.TensorXf: ...
    def sample(self: mitsuba.cuda_spectral.SamplingIntegrator, scene: mitsuba.cuda_spectral.Scene, sampler, ray: mitsuba.cuda_spectral.RayDifferential3f, medium: mitsuba.cuda_spectral.Medium = None, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Bool, List[mitsuba.Float]]:
        """
...
class DirectionSample3f(PositionSample3f):
    ...
    *direct illumination strategies* importance sample the incident
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DirectionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DirectionSample3f, other: mitsuba.cuda_spectral.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DirectionSample3f, other: mitsuba.cuda_spectral.DirectionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DirectionSample3f, p: mitsuba.cuda_spectral.Point3f, n: mitsuba.cuda_spectral.Normal3f, uv: mitsuba.cuda_spectral.Point2f, time: mitsuba.Float, pdf: mitsuba.Float, delta: mitsuba.Bool, d: mitsuba.cuda_spectral.Vector3f, dist: mitsuba.Float, emitter: mitsuba.cuda_spectral.EmitterPtr) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DirectionSample3f, scene: mitsuba.cuda_spectral.Scene, si: mitsuba.cuda_spectral.SurfaceInteraction3f, ref: mitsuba.cuda_spectral.Interaction3f) -> None:
        """
    ...
    def assign(self: mitsuba.cuda_spectral.DirectionSample3f, arg0: mitsuba.cuda_spectral.DirectionSample3f) -> None: ...
    ...
...
class DiscreteDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DiscreteDistribution) -> None:
        """
        Discrete 1D probability distribution
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DiscreteDistribution, arg0: mitsuba.cuda_spectral.DiscreteDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.DiscreteDistribution, pmf: mitsuba.Float) -> None:
        """
        Initialize from a given probability mass function
        """
        ...

    def cdf(self: mitsuba.cuda_spectral.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the unnormalized cumulative distribution function
        """
        ...

    def empty(self: mitsuba.cuda_spectral.DiscreteDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_spectral.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        index ``index``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_spectral.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pmf(self: mitsuba.cuda_spectral.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_pmf_normalized(self: mitsuba.cuda_spectral.DiscreteDistribution, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def normalization(self: mitsuba.cuda_spectral.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pmf(self: mitsuba.cuda_spectral.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the unnormalized probability mass function
        """
        ...

    def sample(self: mitsuba.cuda_spectral.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.UInt:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pmf(self: mitsuba.cuda_spectral.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse(self: mitsuba.cuda_spectral.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse_pmf(self: mitsuba.cuda_spectral.DiscreteDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution.
    ...
    def size(self: mitsuba.cuda_spectral.DiscreteDistribution) -> int:
        """
        Return the number of entries
        """
        ...

    def sum(self: mitsuba.cuda_spectral.DiscreteDistribution) -> mitsuba.Float:
        """
        Return the original sum of PMF entries before normalization
        """
        ...

    def update(self: mitsuba.cuda_spectral.DiscreteDistribution) -> None:
        """
...
class DiscreteDistribution2D:
    def __init__(self: mitsuba.cuda_spectral.DiscreteDistribution2D, data: numpy.ndarray[numpy.float32]) -> None: ...
    def eval(self: mitsuba.cuda_spectral.DiscreteDistribution2D, pos: mitsuba.cuda_spectral.Point2u, active: mitsuba.Bool = True) -> mitsuba.Float: ...
    def pdf(self: mitsuba.cuda_spectral.DiscreteDistribution2D, pos: mitsuba.cuda_spectral.Point2u, active: mitsuba.Bool = True) -> mitsuba.Float: ...
    def sample(self: mitsuba.cuda_spectral.DiscreteDistribution2D, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2u, mitsuba.Float, mitsuba.cuda_spectral.Point2f]: ...
    ...
...
class Emitter(Endpoint):
    def __init__(self: mitsuba.cuda_spectral.Emitter, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...

    def bbox(self: mitsuba.cuda_spectral.Endpoint) -> mitsuba.BoundingBox3f:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.Endpoint, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_direction(self: mitsuba.cuda_spectral.Endpoint, it, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def flags(self: mitsuba.cuda_spectral.Emitter, active: mitsuba.Bool = True) -> int:
        """
        Flags for all components combined.
        """
        ...
    ...
    def is_environment(self: mitsuba.cuda_spectral.Emitter) -> bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def medium(self: mitsuba.cuda_spectral.Endpoint) -> mitsuba.cuda_spectral.Medium:
        """
        Return a pointer to the medium that surrounds the emitter
        """
        ...

    def needs_sample_2(self: mitsuba.cuda_spectral.Endpoint) -> bool:
        """
    ...
    def needs_sample_3(self: mitsuba.cuda_spectral.Endpoint) -> bool:
        """
        Does the method sample_ray() require a uniformly distributed 2D sample
    ...
    def pdf_direction(self: mitsuba.cuda_spectral.Endpoint, it, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_spectral.Endpoint, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample_direction(self: mitsuba.cuda_spectral.Endpoint, it, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_position(self: mitsuba.cuda_spectral.Endpoint, ref: mitsuba.Float, ds: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_ray(self: mitsuba.cuda_spectral.Endpoint, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Ray3f, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def sample_wavelengths(self: mitsuba.cuda_spectral.Endpoint, si, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def sampling_weight(self: mitsuba.cuda_spectral.Emitter) -> float:
        """
    ...
    def set_medium(self: mitsuba.cuda_spectral.Endpoint, medium: mitsuba.cuda_spectral.Medium) -> None:
        """
        Set the medium that surrounds the emitter.
        """
        ...

    def set_scene(self: mitsuba.cuda_spectral.Endpoint, scene: mitsuba.cuda_spectral.Scene) -> None:
        """
    ...
    def set_shape(self: mitsuba.cuda_spectral.Endpoint, shape: mitsuba.cuda_spectral.Shape) -> None:
        """
        Set the shape associated with this endpoint.
        """
        ...

    def shape(self: mitsuba.cuda_spectral.Endpoint) -> mitsuba.cuda_spectral.Shape:
        """
    ...
    def world_transform(self: mitsuba.cuda_spectral.Endpoint) -> mitsuba.cuda_spectral.Transform4f:
        """
...
class EmitterPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.EmitterPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.EmitterPtr, arg0: mitsuba.cuda_spectral.Emitter) -> None: ...
    class Emitter(Endpoint):
        def __init__(self: mitsuba.cuda_spectral.Emitter, arg0: mitsuba.Properties) -> None: ...
        m_flags = ...
        m_needs_sample_2 = ...
    ...
    def assign(self: mitsuba.cuda_spectral.EmitterPtr, arg0: mitsuba.cuda_spectral.EmitterPtr) -> None: ...
    def eval(self: mitsuba.cuda_spectral.EmitterPtr, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_spectral.EmitterPtr, it, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def flags(self: mitsuba.cuda_spectral.EmitterPtr) -> mitsuba.UInt:
        """
        Flags for all components combined.
        """
        ...

    def is_environment(self: mitsuba.cuda_spectral.EmitterPtr) -> mitsuba.Bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def pdf_direction(self: mitsuba.cuda_spectral.EmitterPtr, it, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_spectral.EmitterPtr, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_spectral.EmitterPtr, it, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_spectral.EmitterPtr, time: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_spectral.EmitterPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Ray3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_spectral.EmitterPtr, si, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def sampling_weight(self: mitsuba.cuda_spectral.EmitterPtr) -> mitsuba.Float:
        """
        The emitter's sampling weight.
        """
        ...

    def shape(self: mitsuba.cuda_spectral.EmitterPtr) -> mitsuba.cuda_spectral.ShapePtr:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
class Film(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.Film, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def base_channels_count(self: mitsuba.cuda_spectral.Film) -> int:
        """
        Return the number of channels for the developed image (excluding AOVS)
        """
        ...

    def bitmap(self: mitsuba.cuda_spectral.Film, raw: bool = False) -> mitsuba.Bitmap:
        """
        Return a bitmap object storing the developed contents of the film
        """
        ...

    def clear(self: mitsuba.cuda_spectral.Film) -> None:
        """
        Clear the film contents to zero.
        """
        ...

    def create_block(self: mitsuba.cuda_spectral.Film, size: mitsuba.Vector2u = [0, 0], normalize: bool = False, borders: bool = False):
        """
    ...
    def crop_offset(self: mitsuba.cuda_spectral.Film) -> mitsuba.Point2u:
        """
        Return the offset of the crop window
        """
        ...

    def crop_size(self: mitsuba.cuda_spectral.Film) -> mitsuba.Vector2u:
        """
    ...
    def develop(self: mitsuba.cuda_spectral.Film, raw: bool = False) -> mitsuba.TensorXf:
        """
    ...
    def flags(self: mitsuba.cuda_spectral.Film) -> int:
        """
    ...
    def prepare(self: mitsuba.cuda_spectral.Film, aovs: List[str]) -> int:
        """
    ...
    def prepare_sample(self: mitsuba.cuda_spectral.Film, spec: mitsuba.cuda_spectral.Spectrum, wavelengths: mitsuba.cuda_spectral.Spectrum, nChannels: int, weight: mitsuba.Float = 1.0, alpha: mitsuba.Float = 1.0, active: mitsuba.Bool = True) -> List[mitsuba.Float]:
        """
    ...
    def put_block(self: mitsuba.cuda_spectral.Film, block) -> None:
        """
    ...
    def rfilter(self: mitsuba.cuda_spectral.Film) -> mitsuba.cuda_spectral.ReconstructionFilter:
        """
        Return the image reconstruction filter (const version)
        """
        ...

    def sample_border(self: mitsuba.cuda_spectral.Film) -> bool:
        """
    ...
    def schedule_storage(self: mitsuba.cuda_spectral.Film) -> None:
        """
        dr::schedule() variables that represent the internal film storage
        """
        ...

    def sensor_response_function(self: mitsuba.cuda_spectral.Film):
        """
    ...
    def size(self: mitsuba.cuda_spectral.Film) -> mitsuba.Vector2u:
        """
    ...
    def write(self: mitsuba.cuda_spectral.Film, path: mitsuba.filesystem.path) -> None:
        """
...
class Frame3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Frame3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Frame3f, arg0: mitsuba.cuda_spectral.Frame3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Frame3f, arg0: mitsuba.cuda_spectral.Vector3f, arg1: mitsuba.cuda_spectral.Vector3f, arg2: mitsuba.cuda_spectral.Vector3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Frame3f, arg0: mitsuba.cuda_spectral.Vector3f) -> None: ...
    n = ...
    s = ...
    t = ...

    def assign(self: mitsuba.cuda_spectral.Frame3f, arg0: mitsuba.cuda_spectral.Frame3f) -> None: ...
    def to_local(self: mitsuba.cuda_spectral.Frame3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Convert from world coordinates to local coordinates
        """
        ...

    def to_world(self: mitsuba.cuda_spectral.Frame3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
...
class Hierarchical2D0:
    ...
    def __init__(self: mitsuba.cuda_spectral.Hierarchical2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.Hierarchical2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def invert(self: mitsuba.cuda_spectral.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.Hierarchical2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
...
class Hierarchical2D1:
    ...
    def __init__(self: mitsuba.cuda_spectral.Hierarchical2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.Hierarchical2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.Hierarchical2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D2:
    ...
    def __init__(self: mitsuba.cuda_spectral.Hierarchical2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.Hierarchical2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.Hierarchical2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D3:
    ...
    def __init__(self: mitsuba.cuda_spectral.Hierarchical2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.Hierarchical2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.Hierarchical2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class ImageBlock(Object):
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ImageBlock, size: mitsuba.Vector2u, offset: mitsuba.Point2i, channel_count: int, rfilter: mitsuba.cuda_spectral.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = True, compensate: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ImageBlock, tensor: mitsuba.TensorXf, offset: mitsuba.Point2i = [0, 0], rfilter: mitsuba.cuda_spectral.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = True, compensate: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    ptr = ...

    def border_size(self: mitsuba.cuda_spectral.ImageBlock) -> int:
        """
        Return the border region used by the reconstruction filter
        """
        ...

    def channel_count(self: mitsuba.cuda_spectral.ImageBlock) -> int:
        """
        Return the number of channels stored by the image block
        """
        ...

    def clear(self: mitsuba.cuda_spectral.ImageBlock) -> None:
        """
        Clear the image block contents to zero.
        """
        ...

    def coalesce(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
        Try to coalesce reads/writes in JIT modes?
        """
        ...

    def compensate(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
    ...
    def has_border(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
        Does the image block have a border region?
        """
        ...

    def height(self: mitsuba.cuda_spectral.ImageBlock) -> int:
        """
        Return the bitmap's height in pixels
        """
        ...
    ...
    def normalize(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def offset(self: mitsuba.cuda_spectral.ImageBlock) -> mitsuba.Point2i:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_spectral.ImageBlock, pos: mitsuba.cuda_spectral.Point2f, wavelengths: mitsuba.cuda_spectral.Spectrum, value: mitsuba.cuda_spectral.Spectrum, alpha: mitsuba.Float = 1.0, weight: mitsuba.Float = 1, active: mitsuba.Bool = True) -> None:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_spectral.ImageBlock, pos: mitsuba.cuda_spectral.Point2f, values: List[mitsuba.Float], active: mitsuba.Bool = True) -> None: ...
    def put_block(self: mitsuba.cuda_spectral.ImageBlock, block: mitsuba.cuda_spectral.ImageBlock) -> None:
        """
        Accumulate another image block into this one
        """
        ...

    def read(self: mitsuba.cuda_spectral.ImageBlock, pos: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> List[mitsuba.Float]: ...
    def ref_count(self: mitsuba.Object) -> int:
        """
        Return the current reference count
        """
    ...
    def rfilter(self: mitsuba.cuda_spectral.ImageBlock) -> mitsuba.cuda_spectral.ReconstructionFilter:
        """
        Return the image reconstruction filter underlying the ImageBlock
        """
        ...

    def set_coalesce(self: mitsuba.cuda_spectral.ImageBlock, arg0: bool) -> None:
        """
        Try to coalesce reads/writes in JIT modes?
        """
        ...

    def set_compensate(self: mitsuba.cuda_spectral.ImageBlock, arg0: bool) -> None:
        """
        Use Kahan-style error-compensated floating point accumulation?
        """
        ...
    ...
    def set_normalize(self: mitsuba.cuda_spectral.ImageBlock, arg0: bool) -> None:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def set_offset(self: mitsuba.cuda_spectral.ImageBlock, offset: mitsuba.Point2i) -> None:
        """
    ...
    def set_size(self: mitsuba.cuda_spectral.ImageBlock, size: mitsuba.Vector2u) -> None:
        """
        Set the block size. This potentially destroys the block's content.
        """
        ...

    def set_warn_invalid(self: mitsuba.cuda_spectral.ImageBlock, value: bool) -> None:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def set_warn_negative(self: mitsuba.cuda_spectral.ImageBlock, value: bool) -> None:
        """
        Warn when writing negative sample values?
        """
        ...

    def size(self: mitsuba.cuda_spectral.ImageBlock) -> mitsuba.Vector2u:
        """
        Return the current block size
        """
        ...

    def tensor(self: mitsuba.cuda_spectral.ImageBlock) -> mitsuba.TensorXf:
        """
    ...
    def warn_invalid(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def warn_negative(self: mitsuba.cuda_spectral.ImageBlock) -> bool:
        """
        Warn when writing negative sample values?
        """
        ...

    def width(self: mitsuba.cuda_spectral.ImageBlock) -> int:
        """
        Return the bitmap's width in pixels
        """
        ...
...
class Int:
    ...
    @overload
    def __init__(self: mitsuba.Int, arg0) -> None: ...
    @overload
...
class Int64:
    ...
    @overload
    def __init__(self: mitsuba.Int64, arg0) -> None: ...
    @overload
...
class Interaction3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Interaction3f) -> None:
        """
        Constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Interaction3f, arg0: mitsuba.cuda_spectral.Interaction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Interaction3f, t: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_spectral.Spectrum, p: mitsuba.cuda_spectral.Point3f, n: mitsuba.cuda_spectral.Normal3f = 0) -> None:
        """
        //! @}
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.Interaction3f, arg0: mitsuba.cuda_spectral.Interaction3f) -> None: ...
    def is_valid(self: mitsuba.cuda_spectral.Interaction3f) -> mitsuba.Bool:
        """
        Is the current interaction valid?
        """
        ...

    def spawn_ray(self: mitsuba.cuda_spectral.Interaction3f, d: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Ray3f:
        """
        Spawn a semi-infinite ray towards the given direction
        """
        ...

    def spawn_ray_to(self: mitsuba.cuda_spectral.Interaction3f, t: mitsuba.cuda_spectral.Point3f) -> mitsuba.cuda_spectral.Ray3f:
        """
...
class IrregularContinuousDistribution:
    ...
    *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of an
        *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, arg0: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, nodes: mitsuba.Float, pdf: mitsuba.Float) -> None:
        """
    ...
    def cdf(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the unnormalized discrete cumulative distribution function over
        intervals
        """
    ...
    def empty(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the unnormalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the normalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def integral(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def max(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> float: ...
    def nodes(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the nodes of the underlying discretization
        """
        ...

    def normalization(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Float:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> mitsuba.Array2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pdf(self: mitsuba.cuda_spectral.IrregularContinuousDistribution, value: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.Float, mitsuba.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.cuda_spectral.IrregularContinuousDistribution) -> None:
        """
...
class MarginalContinuous2D0:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalContinuous2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalContinuous2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalContinuous2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D1:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalContinuous2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalContinuous2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalContinuous2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D2:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalContinuous2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalContinuous2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalContinuous2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D3:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalContinuous2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalContinuous2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalContinuous2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D0:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalDiscrete2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalDiscrete2D0, pos: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalDiscrete2D0, sample: mitsuba.Array2f, param: mitsuba.Array0f = [], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D1:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalDiscrete2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalDiscrete2D1, pos: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalDiscrete2D1, sample: mitsuba.Array2f, param: mitsuba.Array1f = [0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D2:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalDiscrete2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalDiscrete2D2, pos: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalDiscrete2D2, sample: mitsuba.Array2f, param: mitsuba.Array2f = [0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D3:
    ...
    def __init__(self: mitsuba.cuda_spectral.MarginalDiscrete2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_spectral.MarginalDiscrete2D3, pos: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_spectral.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_spectral.MarginalDiscrete2D3, sample: mitsuba.Array2f, param: mitsuba.Array3f = [0.0, 0.0, 0.0], active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Medium(Object):
    def __init__(self: mitsuba.cuda_spectral.Medium, arg0: mitsuba.Properties) -> None: ...
    ...
    def get_majorant(self: mitsuba.cuda_spectral.Medium, mi, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_spectral.Medium, mi, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def has_spectral_extinction(self: mitsuba.cuda_spectral.Medium) -> bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def id(self: mitsuba.cuda_spectral.Medium) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def intersect_aabb(self: mitsuba.cuda_spectral.Medium, ray: mitsuba.cuda_spectral.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.cuda_spectral.Medium) -> bool:
        """
    ...
    def phase_function(self: mitsuba.cuda_spectral.Medium):
        """
    ...
    def sample_interaction(self: mitsuba.cuda_spectral.Medium, ray: mitsuba.cuda_spectral.Ray3f, sample: mitsuba.Float, channel: mitsuba.UInt, active: mitsuba.Bool):
        """
    ...
    def transmittance_eval_pdf(self: mitsuba.cuda_spectral.Medium, mi, si, active: mitsuba.Bool) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def use_emitter_sampling(self: mitsuba.cuda_spectral.Medium) -> bool:
        """
...
class MediumInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MediumInteraction3f) -> None:
        """
        //! @}
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MediumInteraction3f, arg0: mitsuba.cuda_spectral.MediumInteraction3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.MediumInteraction3f, arg0: mitsuba.cuda_spectral.MediumInteraction3f) -> None: ...
    def is_valid(self: mitsuba.cuda_spectral.Interaction3f) -> mitsuba.Bool:
        """
        Is the current interaction valid?
        """
    ...
    def to_local(self: mitsuba.cuda_spectral.MediumInteraction3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
    ...
    def to_world(self: mitsuba.cuda_spectral.MediumInteraction3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
...
class MediumPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.MediumPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MediumPtr, arg0: mitsuba.cuda_spectral.Medium) -> None: ...
    class Medium(Object):
        def __init__(self: mitsuba.cuda_spectral.Medium, arg0: mitsuba.Properties) -> None: ...
        m_has_spectral_extinction = ...
        m_is_homogeneous = ...
    ...
    def assign(self: mitsuba.cuda_spectral.MediumPtr, arg0: mitsuba.cuda_spectral.MediumPtr) -> None: ...
    def get_majorant(self: mitsuba.cuda_spectral.MediumPtr, mi, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_spectral.MediumPtr, mi, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
        Returns the medium coefficients Sigma_s, Sigma_n and Sigma_t evaluated
        at a given MediumInteraction mi
        """
    ...
    def has_spectral_extinction(self: mitsuba.cuda_spectral.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def intersect_aabb(self: mitsuba.cuda_spectral.MediumPtr, ray: mitsuba.cuda_spectral.Ray3f) -> Tuple[mitsuba.Bool, mitsuba.Float, mitsuba.Float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.cuda_spectral.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this medium is homogeneous
        """
        ...

    def phase_function(self: mitsuba.cuda_spectral.MediumPtr):
        """
        Return the phase function of this medium
        """
        ...

    def sample_interaction(self: mitsuba.cuda_spectral.MediumPtr, ray: mitsuba.cuda_spectral.Ray3f, sample: mitsuba.Float, channel: mitsuba.UInt, active: mitsuba.Bool):
        """
        Sample a free-flight distance in the medium.
    ...
    def transmittance_eval_pdf(self: mitsuba.cuda_spectral.MediumPtr, mi, si, active: mitsuba.Bool) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
        Compute the transmittance and PDF
    ...
    def use_emitter_sampling(self: mitsuba.cuda_spectral.MediumPtr) -> mitsuba.Bool:
        """
        Returns whether this specific medium instance uses emitter sampling
        """
        ...
...
class Mesh(Shape):
    @overload
    def __init__(self: mitsuba.cuda_spectral.Mesh, props: mitsuba.Properties) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Mesh, name: str, vertex_count: int, face_count: int, props: mitsuba.Properties = Properties(), has_vertex_normals: bool = False, has_vertex_texcoords: bool = False) -> None:
        """
    ...
    def add_attribute(self: mitsuba.cuda_spectral.Mesh, name: str, size: int, buffer: List[float]) -> None:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_spectral.Shape) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_spectral.Shape, index: int) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_spectral.Shape, index: int, clip: mitsuba.BoundingBox3f) -> mitsuba.BoundingBox3f:
        """
    ...
    def bsdf(self: mitsuba.cuda_spectral.Shape):
        """
        Return the shape's BSDF
        """
        ...

    def compute_surface_interaction(self: mitsuba.cuda_spectral.Shape, ray: mitsuba.cuda_spectral.Ray3f, pi, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def differential_motion(self: mitsuba.cuda_spectral.Shape, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
    ...
    def effective_primitive_count(self: mitsuba.cuda_spectral.Shape) -> int:
        """
    ...
    def emitter(self: mitsuba.cuda_spectral.Shape):
        """
        Return the area emitter associated with this shape (if any)
        """
        ...

    def eval_attribute(self: mitsuba.cuda_spectral.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_attribute_1(self: mitsuba.cuda_spectral.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_attribute_3(self: mitsuba.cuda_spectral.Shape, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
        """
    ...
    def eval_parameterization(self: mitsuba.cuda_spectral.Shape, uv: mitsuba.cuda_spectral.Point2f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def exterior_medium(self: mitsuba.cuda_spectral.Shape):
        """
        Return the medium that lies on the exterior of this shape
        """
        ...

    def face_count(self: mitsuba.cuda_spectral.Mesh) -> int:
        """
        Return the total number of faces
        """
        ...

    def face_indices(self: mitsuba.cuda_spectral.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Array3u:
        """
        Returns the vertex indices associated with triangle ``index``
        """
        ...

    def has_attribute(self: mitsuba.cuda_spectral.Shape, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def has_vertex_normals(self: mitsuba.cuda_spectral.Mesh) -> bool:
        """
        Does this mesh have per-vertex normals?
        """
        ...

    def has_vertex_texcoords(self: mitsuba.cuda_spectral.Mesh) -> bool:
        """
        Does this mesh have per-vertex texture coordinates?
        """
        ...

    def id(self: mitsuba.cuda_spectral.Shape) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def initialize(self: mitsuba.cuda_spectral.Mesh) -> None:
        """
    ...
    def interior_medium(self: mitsuba.cuda_spectral.Shape):
        """
        Return the medium that lies on the interior of this shape
        """
        ...

    def invert_silhouette_sample(self: mitsuba.cuda_spectral.Shape, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
    ...
    def is_emitter(self: mitsuba.cuda_spectral.Shape) -> bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_spectral.Shape) -> bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_mesh(self: mitsuba.cuda_spectral.Shape) -> bool:
        """
        Is this shape a triangle mesh?
        """
        ...

    def is_sensor(self: mitsuba.cuda_spectral.Shape) -> bool:
        """
    ...
    def parameters_grad_enabled(self: mitsuba.cuda_spectral.Shape) -> bool:
        """
    ...
    def pdf_direction(self: mitsuba.cuda_spectral.Shape, it, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_spectral.Shape, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def precompute_silhouette(self: mitsuba.cuda_spectral.Shape, viewpoint: mitsuba.Point3f) -> Tuple[mitsuba.UInt, mitsuba.Float]:
        """
    ...
    def primitive_count(self: mitsuba.cuda_spectral.Shape) -> int:
        """
    ...
    def primitive_silhouette_projection(self: mitsuba.cuda_spectral.Shape, viewpoint: mitsuba.cuda_spectral.Point3f, si, flags: int, sample: mitsuba.Float, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect(self: mitsuba.cuda_spectral.Shape, ray: mitsuba.cuda_spectral.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_spectral.Shape, ray: mitsuba.cuda_spectral.Ray3f, prim_index: int = 0, active: mitsuba.Bool = True):
        """
    ...
    def ray_intersect_triangle(self: mitsuba.cuda_spectral.Mesh, index: mitsuba.UInt, ray: mitsuba.cuda_spectral.Ray3f, active: mitsuba.Bool = True): ...
    def ray_test(self: mitsuba.cuda_spectral.Shape, ray: mitsuba.cuda_spectral.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
    ...
    def sample_direction(self: mitsuba.cuda_spectral.Shape, it, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_position(self: mitsuba.cuda_spectral.Shape, time: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
    ...
    def sample_precomputed_silhouette(self: mitsuba.cuda_spectral.Shape, viewpoint: mitsuba.cuda_spectral.Point3f, sample1: mitsuba.UInt, sample2: mitsuba.Float, active: mitsuba.Bool = True):
        """
    ...
    def sample_silhouette(self: mitsuba.cuda_spectral.Shape, sample: mitsuba.cuda_spectral.Point3f, flags: int, active: mitsuba.Bool = True):
        """
    ...
    def sensor(self: mitsuba.cuda_spectral.Shape):
        """
    ...
    def shape_type(self: mitsuba.cuda_spectral.Shape) -> int:
        """
        Returns the shape type ShapeType of this shape
        """
        ...

    def silhouette_discontinuity_types(self: mitsuba.cuda_spectral.Shape) -> int:
        """
        //! @{ \name Silhouette sampling routines and other utilities
        """
        ...

    def silhouette_sampling_weight(self: mitsuba.cuda_spectral.Shape) -> float:
        """
        Return this shape's sampling weight w.r.t. all shapes in the scene
        """
        ...

    def surface_area(self: mitsuba.cuda_spectral.Shape) -> mitsuba.Float:
        """
    ...
    def vertex_count(self: mitsuba.cuda_spectral.Mesh) -> int:
        """
        Return the total number of vertices
        """
        ...

    def vertex_normal(self: mitsuba.cuda_spectral.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Normal3f:
        """
        Returns the normal direction of the vertex with index ``index``
        """
        ...

    def vertex_position(self: mitsuba.cuda_spectral.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
        Returns the world-space position of the vertex with index ``index``
        """
        ...

    def vertex_texcoord(self: mitsuba.cuda_spectral.Mesh, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point2f:
        """
    ...
    @overload
    def write_ply(self: mitsuba.cuda_spectral.Mesh, filename: str) -> None:
        """
    ...
    @overload
    def write_ply(self: mitsuba.cuda_spectral.Mesh, stream: mitsuba.Stream) -> None:
        """
...
class MicrofacetDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: mitsuba.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: mitsuba.Float, alpha_v: mitsuba.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.MicrofacetDistribution, arg0: mitsuba.Properties) -> None: ...
    def G(self: mitsuba.cuda_spectral.MicrofacetDistribution, wi: mitsuba.cuda_spectral.Vector3f, wo: mitsuba.cuda_spectral.Vector3f, m: mitsuba.cuda_spectral.Vector3f) -> mitsuba.Float:
        """
        Smith's separable shadowing-masking approximation
        """
        ...

    def alpha(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness (isotropic case)
        """
        ...

    def alpha_u(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness along the tangent direction
        """
        ...

    def alpha_v(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> mitsuba.Float:
        """
        Return the roughness along the bitangent direction
        """
        ...

    def eval(self: mitsuba.cuda_spectral.MicrofacetDistribution, m: mitsuba.cuda_spectral.Vector3f) -> mitsuba.Float:
        """
    ...
    def is_anisotropic(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> bool:
        """
        Is this an anisotropic microfacet distribution?
        """
        ...

    def is_isotropic(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> bool:
        """
        Is this an isotropic microfacet distribution?
        """
        ...

    def pdf(self: mitsuba.cuda_spectral.MicrofacetDistribution, wi: mitsuba.cuda_spectral.Vector3f, m: mitsuba.cuda_spectral.Vector3f) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_spectral.MicrofacetDistribution, wi: mitsuba.cuda_spectral.Vector3f, sample: mitsuba.cuda_spectral.Point2f) -> Tuple[mitsuba.cuda_spectral.Normal3f, mitsuba.Float]:
        """
    ...
    def sample_visible(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> bool:
        """
        Return whether or not only visible normals are sampled?
        """
        ...

    def sample_visible_11(self: mitsuba.cuda_spectral.MicrofacetDistribution, cos_theta_i: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f) -> mitsuba.cuda_spectral.Vector2f:
        """
        Visible normal sampling code for the alpha=1 case
        """
        ...

    def scale_alpha(self: mitsuba.cuda_spectral.MicrofacetDistribution, value: mitsuba.Float) -> None:
        """
        Scale the roughness values by some constant
        """
        ...

    def smith_g1(self: mitsuba.cuda_spectral.MicrofacetDistribution, v: mitsuba.cuda_spectral.Vector3f, m: mitsuba.cuda_spectral.Vector3f) -> mitsuba.Float:
        """
    ...
    def type(self: mitsuba.cuda_spectral.MicrofacetDistribution) -> mitsuba.MicrofacetType:
        """
...
class Normal3d:
    def __init__(self: mitsuba.cuda_spectral.Normal3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Normal3f:
    def __init__(self: mitsuba.cuda_spectral.Normal3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class ObjectPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.ObjectPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ObjectPtr, arg0: mitsuba.Object) -> None: ...
    class Object:
        """
        Object base class with builtin reference counting
    ...
    def assign(self: mitsuba.cuda_spectral.ObjectPtr, arg0: mitsuba.cuda_spectral.ObjectPtr) -> None: ...
    ...
...
class OptixDenoiser(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.OptixDenoiser, input_size: mitsuba.Vector2u, albedo: bool = False, normals: bool = False, temporal: bool = False) -> None:
        """
    ...
    @overload
    def __call__(self: mitsuba.cuda_spectral.OptixDenoiser, noisy: mitsuba.TensorXf, denoise_alpha: bool = True, albedo: mitsuba.TensorXf = [], normals: mitsuba.TensorXf = [], to_sensor: object = None, flow: mitsuba.TensorXf = [], previous_denoised: mitsuba.TensorXf = []) -> mitsuba.TensorXf:
        """
    ...
    @overload
    def __call__(self: mitsuba.cuda_spectral.OptixDenoiser, noisy: mitsuba.Bitmap, denoise_alpha: bool = True, albedo_ch: str = '', normals_ch: str = '', to_sensor: object = None, flow_ch: str = '', previous_denoised_ch: str = '', noisy_ch: str = '<root>') -> mitsuba.Bitmap:
        """
...
class PhaseFunction(Object):
    def __init__(self: mitsuba.cuda_spectral.PhaseFunction, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.cuda_spectral.PhaseFunction, active: mitsuba.Bool = True) -> int:
        """
    ...
    def eval_pdf(self: mitsuba.cuda_spectral.PhaseFunction, ctx: mitsuba.cuda_spectral.PhaseFunctionContext, mi: mitsuba.cuda_spectral.MediumInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_spectral.PhaseFunction, index: int, active: mitsuba.Bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_spectral.PhaseFunction, active: mitsuba.Bool = True) -> int:
        """
        Flags for this phase function.
        """
        ...

    def id(self: mitsuba.cuda_spectral.PhaseFunction) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def max_projected_area(self: mitsuba.cuda_spectral.PhaseFunction) -> mitsuba.Float:
        """
    ...
    def projected_area(self: mitsuba.cuda_spectral.PhaseFunction, mi: mitsuba.cuda_spectral.MediumInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def sample(self: mitsuba.cuda_spectral.PhaseFunction, ctx: mitsuba.cuda_spectral.PhaseFunctionContext, mi: mitsuba.cuda_spectral.MediumInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Vector3f, mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
...
class PhaseFunctionContext:
    def __init__(self: mitsuba.cuda_spectral.PhaseFunctionContext, sampler, mode: mitsuba.TransportMode = TransportMode.Radiance) -> None:
        """
        //! @}
        """
        ...
    ...
    def reverse(self: mitsuba.cuda_spectral.PhaseFunctionContext) -> None:
        """
        Reverse the direction of light transport in the record
...
class PhaseFunctionPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.PhaseFunctionPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PhaseFunctionPtr, arg0: mitsuba.cuda_spectral.PhaseFunction) -> None: ...
    class PhaseFunction(Object):
        def __init__(self: mitsuba.cuda_spectral.PhaseFunction, arg0: mitsuba.Properties) -> None: ...
        m_flags = ...
        ptr = ...
    ...
    def assign(self: mitsuba.cuda_spectral.PhaseFunctionPtr, arg0: mitsuba.cuda_spectral.PhaseFunctionPtr) -> None: ...
    def component_count(self: mitsuba.cuda_spectral.PhaseFunctionPtr, active: mitsuba.Bool = True) -> mitsuba.UInt64:
        """
        Number of components this phase function is comprised of.
        """
        ...

    def eval_pdf(self: mitsuba.cuda_spectral.PhaseFunctionPtr, ctx: mitsuba.cuda_spectral.PhaseFunctionContext, mi: mitsuba.cuda_spectral.MediumInteraction3f, wo: mitsuba.cuda_spectral.Vector3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
        Evaluates the phase function model value and PDF
    ...
    def flags(self: mitsuba.cuda_spectral.PhaseFunctionPtr, active: mitsuba.Bool = True) -> mitsuba.UInt:
        """
        Flags for this phase function.
        """
        ...

    def max_projected_area(self: mitsuba.cuda_spectral.PhaseFunctionPtr) -> mitsuba.Float:
        """
        Return the maximum projected area of the microflake distribution
        """
        ...

    def projected_area(self: mitsuba.cuda_spectral.PhaseFunctionPtr, mi: mitsuba.cuda_spectral.MediumInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Returns the microflake projected area
    ...
    def sample(self: mitsuba.cuda_spectral.PhaseFunctionPtr, ctx: mitsuba.cuda_spectral.PhaseFunctionContext, mi: mitsuba.cuda_spectral.MediumInteraction3f, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Vector3f, mitsuba.cuda_spectral.Spectrum, mitsuba.Float]:
        """
        Importance sample the phase function model
...
class Point0d:
    def __init__(self: mitsuba.cuda_spectral.Point0d, *args) -> None: ...
    label = ...
...
class Point0f:
    def __init__(self: mitsuba.cuda_spectral.Point0f, *args) -> None: ...
    label = ...
...
class Point0i:
    def __init__(self: mitsuba.cuda_spectral.Point0i, *args) -> None: ...
    label = ...
...
class Point0u:
    def __init__(self: mitsuba.cuda_spectral.Point0u, *args) -> None: ...
    label = ...
...
class Point1d:
    def __init__(self: mitsuba.cuda_spectral.Point1d, *args) -> None: ...
    label = ...
    x = ...
...
class Point1f:
    def __init__(self: mitsuba.cuda_spectral.Point1f, *args) -> None: ...
    label = ...
    x = ...
...
class Point1i:
    def __init__(self: mitsuba.cuda_spectral.Point1i, *args) -> None: ...
    label = ...
    x = ...
...
class Point1u:
    def __init__(self: mitsuba.cuda_spectral.Point1u, *args) -> None: ...
    label = ...
    x = ...
...
class Point2d:
    def __init__(self: mitsuba.cuda_spectral.Point2d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point2f:
    def __init__(self: mitsuba.cuda_spectral.Point2f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point2i:
    def __init__(self: mitsuba.cuda_spectral.Point2i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point2u:
    def __init__(self: mitsuba.cuda_spectral.Point2u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point3d:
    def __init__(self: mitsuba.cuda_spectral.Point3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Point3f:
    def __init__(self: mitsuba.cuda_spectral.Point3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Point3i:
    def __init__(self: mitsuba.cuda_spectral.Point3i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Point3u:
    def __init__(self: mitsuba.cuda_spectral.Point3u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Point4d:
    def __init__(self: mitsuba.cuda_spectral.Point4d, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Point4f:
    def __init__(self: mitsuba.cuda_spectral.Point4f, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Point4i:
    def __init__(self: mitsuba.cuda_spectral.Point4i, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Point4u:
    def __init__(self: mitsuba.cuda_spectral.Point4u, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class PositionSample3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PositionSample3f, other: mitsuba.cuda_spectral.PositionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PositionSample3f, si: mitsuba.cuda_spectral.SurfaceInteraction3f) -> None:
        """
        Create a position sampling record from a surface intersection
    ...
    def assign(self: mitsuba.cuda_spectral.PositionSample3f, arg0: mitsuba.cuda_spectral.PositionSample3f) -> None: ...
    ...
...
class PreliminaryIntersection3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PreliminaryIntersection3f) -> None:
        """
        //! @}
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.PreliminaryIntersection3f, arg0: mitsuba.cuda_spectral.PreliminaryIntersection3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.PreliminaryIntersection3f, arg0: mitsuba.cuda_spectral.PreliminaryIntersection3f) -> None: ...
    def compute_surface_interaction(self: mitsuba.cuda_spectral.PreliminaryIntersection3f, ray: mitsuba.cuda_spectral.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.SurfaceInteraction3f:
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def is_valid(self: mitsuba.cuda_spectral.PreliminaryIntersection3f) -> mitsuba.Bool:
        """
        Is the current interaction valid?
        """
        ...
...
class ProjectiveCamera(Sensor):
    ...
    def eval(self: mitsuba.cuda_spectral.Sensor, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_spectral.Sensor, it: mitsuba.cuda_spectral.Interaction3f, ds: mitsuba.cuda_spectral.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def far_clip(self: mitsuba.cuda_spectral.ProjectiveCamera) -> float:
        """
        Return the far clip plane distance
        """
        ...

    def film(self: mitsuba.cuda_spectral.Sensor) -> mitsuba.cuda_spectral.Film:
        """
        Return the Film instance associated with this sensor
        """
        ...

    def focus_distance(self: mitsuba.cuda_spectral.ProjectiveCamera) -> mitsuba.Float:
        """
    ...
    def near_clip(self: mitsuba.cuda_spectral.ProjectiveCamera) -> float:
        """
        Return the near clip plane distance
        """
        ...

    def needs_aperture_sample(self: mitsuba.cuda_spectral.Sensor) -> bool:
        """
    ...
    def pdf_direction(self: mitsuba.cuda_spectral.Sensor, it: mitsuba.cuda_spectral.Interaction3f, ds: mitsuba.cuda_spectral.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_spectral.Sensor, ps: mitsuba.cuda_spectral.PositionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_spectral.Sensor, it: mitsuba.cuda_spectral.Interaction3f, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.DirectionSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_spectral.Sensor, time: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.PositionSample3f, mitsuba.Float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_spectral.Sensor, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Ray3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    @overload
    def sample_ray_differential(self: mitsuba.cuda_spectral.Sensor, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.RayDifferential3f, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def sample_wavelengths(self: mitsuba.cuda_spectral.Sensor, si: mitsuba.cuda_spectral.SurfaceInteraction3f, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def sampler(self: mitsuba.cuda_spectral.Sensor) -> mitsuba.cuda_spectral.Sampler:
        """
    ...
    def shape(self: mitsuba.cuda_spectral.Sensor) -> mitsuba.cuda_spectral.Shape:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...

    def shutter_open(self: mitsuba.cuda_spectral.Sensor) -> float:
        """
        Return the time value of the shutter opening event
        """
        ...

    def shutter_open_time(self: mitsuba.cuda_spectral.Sensor) -> float:
        """
...
class RadicalInverse(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.RadicalInverse, max_base: int = 8161, scramble: int = -1) -> None: ...
    ptr = ...

    def base(self: mitsuba.cuda_spectral.RadicalInverse, arg0: int) -> int:
        """
    ...
    def bases(self: mitsuba.cuda_spectral.RadicalInverse) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.RadicalInverse, base_index: int, index: mitsuba.UInt64) -> mitsuba.Float:
        """
    ...
    def inverse_permutation(self: mitsuba.cuda_spectral.RadicalInverse, arg0: int) -> int:
        """
    ...
    def scramble(self: mitsuba.cuda_spectral.RadicalInverse) -> int:
        """
...
class Ray2f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray2f, other: mitsuba.cuda_spectral.Ray2f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray2f, o: mitsuba.cuda_spectral.Point2f, d: mitsuba.cuda_spectral.Vector2f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_spectral.Spectrum = []) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray2f, o: mitsuba.cuda_spectral.Point2f, d: mitsuba.cuda_spectral.Vector2f, maxt: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_spectral.Spectrum) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray2f, other: mitsuba.cuda_spectral.Ray2f, maxt: mitsuba.Float) -> None:
        """
        Copy a ray, but change the maxt value
        """
        ...

    def __call__(self: mitsuba.cuda_spectral.Ray2f, t: mitsuba.Float) -> mitsuba.cuda_spectral.Point2f:
        """
    ...
    def assign(self: mitsuba.cuda_spectral.Ray2f, arg0: mitsuba.cuda_spectral.Ray2f) -> None: ...
    ...
...
class Ray3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray3f, other: mitsuba.cuda_spectral.Ray3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray3f, o: mitsuba.cuda_spectral.Point3f, d: mitsuba.cuda_spectral.Vector3f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_spectral.Spectrum = []) -> None:
        """
        Construct a new ray (o, d) with time
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray3f, o: mitsuba.cuda_spectral.Point3f, d: mitsuba.cuda_spectral.Vector3f, maxt: mitsuba.Float, time: mitsuba.Float, wavelengths: mitsuba.cuda_spectral.Spectrum) -> None:
        """
        Construct a new ray (o, d) with bounds
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Ray3f, other: mitsuba.cuda_spectral.Ray3f, maxt: mitsuba.Float) -> None:
        """
        Copy a ray, but change the maxt value
        """
        ...

    def __call__(self: mitsuba.cuda_spectral.Ray3f, t: mitsuba.Float) -> mitsuba.cuda_spectral.Point3f:
        """
        Return the position of a point along the ray
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.Ray3f, arg0: mitsuba.cuda_spectral.Ray3f) -> None: ...
    ...
...
class RayDifferential3f(Ray3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.RayDifferential3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.RayDifferential3f, ray: mitsuba.cuda_spectral.Ray3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.RayDifferential3f, o: mitsuba.cuda_spectral.Point3f, d: mitsuba.cuda_spectral.Vector3f, time: mitsuba.Float = 0.0, wavelengths: mitsuba.cuda_spectral.Spectrum = []) -> None:
        """
    ...
    def assign(self: mitsuba.cuda_spectral.RayDifferential3f, arg0: mitsuba.cuda_spectral.RayDifferential3f) -> None: ...
    def scale_differential(self: mitsuba.cuda_spectral.RayDifferential3f, amount: mitsuba.Float) -> None: ...
    ...
...
class ReconstructionFilter(Object):
    ...
    def border_size(self: mitsuba.cuda_spectral.ReconstructionFilter) -> int:
        """
        Return the block border size required when rendering with this filter
        """
        ...
    ...
    def eval(self: mitsuba.cuda_spectral.ReconstructionFilter, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the filter function
        """
        ...

    def eval_discretized(self: mitsuba.cuda_spectral.ReconstructionFilter, x: mitsuba.Float, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate a discretized version of the filter (generally faster than
        'eval')
        """
    ...
    def is_box_filter(self: mitsuba.cuda_spectral.ReconstructionFilter) -> bool:
        """
        Check whether this is a box filter?
        """
        ...
    ...
    def radius(self: mitsuba.cuda_spectral.ReconstructionFilter) -> float:
        """
        Return the filter's width
        """
        ...
...
class Sampler(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.Sampler, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def advance(self: mitsuba.cuda_spectral.Sampler) -> None:
        """
    ...
    def clone(self: mitsuba.cuda_spectral.Sampler) -> mitsuba.cuda_spectral.Sampler:
        """
    ...
    def fork(self: mitsuba.cuda_spectral.Sampler) -> mitsuba.cuda_spectral.Sampler:
        """
    ...
    def loop_put(self: mitsuba.cuda_spectral.Sampler, loop: mitsuba.LoopBase) -> None:
        """
        Register internal state of this sampler with a symbolic loop
        """
        ...

    def next_1d(self: mitsuba.cuda_spectral.Sampler, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Retrieve the next component value from the current sample
        """
        ...

    def next_2d(self: mitsuba.cuda_spectral.Sampler, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point2f:
        """
    ...
    def sample_count(self: mitsuba.cuda_spectral.Sampler) -> int:
        """
        Return the number of samples per pixel
        """
        ...

    def schedule_state(self: mitsuba.cuda_spectral.Sampler) -> None:
        """
        dr::schedule() variables that represent the internal sampler state
        """
        ...

    def seed(self: mitsuba.cuda_spectral.Sampler, seed: int, wavefront_size: int = 4294967295) -> None:
        """
    ...
    def set_sample_count(self: mitsuba.cuda_spectral.Sampler, spp: int) -> None:
        """
        Set the number of samples per pixel
        """
        ...

    def set_samples_per_wavefront(self: mitsuba.cuda_spectral.Sampler, samples_per_wavefront: int) -> None:
        """
    ...
    def wavefront_size(self: mitsuba.cuda_spectral.Sampler) -> int:
        """
...
class SamplingIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.cuda_spectral.SamplingIntegrator, arg0: mitsuba.Properties) -> None: ...
    hide_emitters = ...
    ptr = ...
...
class Scene(Object):
    ...
    * Sampling directions approximately proportional to the direct
    ...
    def __init__(self: mitsuba.cuda_spectral.Scene, arg0: mitsuba.Properties) -> None: ...
    ptr = ...

    def bbox(self: mitsuba.cuda_spectral.Scene) -> mitsuba.BoundingBox3f:
        """
    ...
    def emitters(self: mitsuba.cuda_spectral.Scene):
        """
        Return the list of emitters
        """
        ...

    def emitters_dr(self: mitsuba.cuda_spectral.Scene):
        """
        Return the list of emitters as a Dr.Jit array
        """
        ...

    def environment(self: mitsuba.cuda_spectral.Scene):
        """
        Return the environment emitter (if any)
        """
        ...

    def eval_emitter_direction(self: mitsuba.cuda_spectral.Scene, ref, ds, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def integrator(self: mitsuba.cuda_spectral.Scene) -> object:
        """
        Return the scene's integrator
        """
        ...

    def invert_silhouette_sample(self: mitsuba.cuda_spectral.Scene, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
        Map a silhouette segment to a point in boundary sample space
    ...
    def pdf_emitter(self: mitsuba.cuda_spectral.Scene, index: mitsuba.UInt, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def pdf_emitter_direction(self: mitsuba.cuda_spectral.Scene, ref, ds, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_spectral.Scene, ray: mitsuba.cuda_spectral.Ray3f, active: mitsuba.Bool = True):
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_spectral.Scene, ray: mitsuba.cuda_spectral.Ray3f, ray_flags: int, coherent: mitsuba.Bool, active: mitsuba.Bool = True):
        """
        Intersect a ray with the shapes comprising the scene and return a
        detailed data structure describing the intersection, if one is found
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_spectral.Scene, ray: mitsuba.cuda_spectral.Ray3f, coherent: mitsuba.Bool = False, active: mitsuba.Bool = True):
        """
    ...
    @overload
    def ray_test(self: mitsuba.cuda_spectral.Scene, ray: mitsuba.cuda_spectral.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
    ...
    @overload
    def ray_test(self: mitsuba.cuda_spectral.Scene, ray: mitsuba.cuda_spectral.Ray3f, coherent: mitsuba.Bool, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
        boolean specifying whether or not an intersection was found.
    ...
    def sample_emitter(self: mitsuba.cuda_spectral.Scene, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.UInt, mitsuba.Float, mitsuba.Float]:
        """
    ...
    def sample_emitter_direction(self: mitsuba.cuda_spectral.Scene, ref, sample: mitsuba.cuda_spectral.Point2f, test_visibility: bool = True, active: mitsuba.Bool = True):
        """
    ...
    def sample_emitter_ray(self: mitsuba.cuda_spectral.Scene, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool):
        """
    ...
    def sample_silhouette(self: mitsuba.cuda_spectral.Scene, sample: mitsuba.cuda_spectral.Point3f, flags: int, active: mitsuba.Bool = True):
        """
        Map a point sample in boundary sample space to a silhouette segment
    ...
    def sensors(self: mitsuba.cuda_spectral.Scene) -> list:
        """
        Return the list of sensors
        """
        ...

    def sensors_dr(self: mitsuba.cuda_spectral.Scene):
        """
    ...
    def shapes(self: mitsuba.cuda_spectral.Scene) -> list:
        """
        Return the list of shapes
        """
        ...

    def shapes_dr(self: mitsuba.cuda_spectral.Scene):
        """
        Return the list of shapes as a Dr.Jit array
        """
        ...

    def shapes_grad_enabled(self: mitsuba.cuda_spectral.Scene) -> bool:
        """
    ...
    def silhouette_shapes(self: mitsuba.cuda_spectral.Scene) -> list:
        """
...
class Sensor(Endpoint):
    def __init__(self: mitsuba.cuda_spectral.Sensor, arg0: mitsuba.Properties) -> None: ...
    m_film = ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...
...
class SensorPtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.SensorPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SensorPtr, arg0: mitsuba.cuda_spectral.Sensor) -> None: ...
    class Sensor(Endpoint):
        def __init__(self: mitsuba.cuda_spectral.Sensor, arg0: mitsuba.Properties) -> None: ...
        m_film = ...
        m_needs_sample_2 = ...
    ...
    def assign(self: mitsuba.cuda_spectral.SensorPtr, arg0: mitsuba.cuda_spectral.SensorPtr) -> None: ...
    def eval(self: mitsuba.cuda_spectral.SensorPtr, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def eval_direction(self: mitsuba.cuda_spectral.SensorPtr, it: mitsuba.cuda_spectral.Interaction3f, ds: mitsuba.cuda_spectral.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Re-evaluate the incident direct radiance/importance of the
        sample_direction() method.
    ...
    def pdf_direction(self: mitsuba.cuda_spectral.SensorPtr, it: mitsuba.cuda_spectral.Interaction3f, ds: mitsuba.cuda_spectral.DirectionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def pdf_position(self: mitsuba.cuda_spectral.SensorPtr, ps: mitsuba.cuda_spectral.PositionSample3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate the probability density of the position sampling method
        implemented by sample_position().
    ...
    def sample_direction(self: mitsuba.cuda_spectral.SensorPtr, it: mitsuba.cuda_spectral.Interaction3f, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.DirectionSample3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_spectral.SensorPtr, time: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.PositionSample3f, mitsuba.Float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_spectral.SensorPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Ray3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_ray_differential(self: mitsuba.cuda_spectral.SensorPtr, time: mitsuba.Float, sample1: mitsuba.Float, sample2: mitsuba.cuda_spectral.Point2f, sample3: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.RayDifferential3f, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a ray differential proportional to the sensor's
        sensitivity profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_spectral.SensorPtr, si: mitsuba.cuda_spectral.SurfaceInteraction3f, sample: mitsuba.Float, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def shape(self: mitsuba.cuda_spectral.SensorPtr) -> mitsuba.cuda_spectral.ShapePtr:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
class ShapePtr:
    @overload
    def __init__(self: mitsuba.cuda_spectral.ShapePtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.ShapePtr, arg0: mitsuba.cuda_spectral.Shape) -> None: ...
    class Shape(Object):
        """
        Forward declaration for `SilhouetteSample`
        """
    ...
    def assign(self: mitsuba.cuda_spectral.ShapePtr, arg0: mitsuba.cuda_spectral.ShapePtr) -> None: ...
    def bsdf(self: mitsuba.cuda_spectral.ShapePtr):
        """
        Return the shape's BSDF
        """
        ...

    def compute_surface_interaction(self: mitsuba.cuda_spectral.ShapePtr, ray: mitsuba.cuda_spectral.Ray3f, pi, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def differential_motion(self: mitsuba.cuda_spectral.ShapePtr, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
        Return the attached (AD) point on the shape's surface
    ...
    def emitter(self: mitsuba.cuda_spectral.ShapePtr):
        """
        Return the area emitter associated with this shape (if any)
        """
        ...

    def eval_attribute(self: mitsuba.cuda_spectral.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
        Evaluate a specific shape attribute at the given surface interaction.
    ...
    def eval_attribute_1(self: mitsuba.cuda_spectral.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Monochromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def eval_attribute_3(self: mitsuba.cuda_spectral.ShapePtr, name: str, si, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
        """
        Trichromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def eval_parameterization(self: mitsuba.cuda_spectral.ShapePtr, uv: mitsuba.cuda_spectral.Point2f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Parameterize the mesh using UV values
    ...
    def exterior_medium(self: mitsuba.cuda_spectral.ShapePtr):
        """
        Return the medium that lies on the exterior of this shape
        """
        ...

    def has_attribute(self: mitsuba.cuda_spectral.ShapePtr, name: str, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Returns whether this shape contains the specified attribute.
    ...
    def interior_medium(self: mitsuba.cuda_spectral.ShapePtr):
        """
        Return the medium that lies on the interior of this shape
        """
        ...

    def invert_silhouette_sample(self: mitsuba.cuda_spectral.ShapePtr, ss, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Point3f:
        """
        Map a silhouette segment to a point in boundary sample space
    ...
    def is_emitter(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.Bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.Bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_sensor(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.Bool:
        """
        Is this shape also an area sensor?
        """
        ...

    def pdf_direction(self: mitsuba.cuda_spectral.ShapePtr, it, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Query the probability density of sample_direction()
    ...
    def pdf_position(self: mitsuba.cuda_spectral.ShapePtr, ps, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Query the probability density of sample_position() for a particular
        point on the surface.
    ...
    def primitive_silhouette_projection(self: mitsuba.cuda_spectral.ShapePtr, viewpoint: mitsuba.cuda_spectral.Point3f, si, flags: int, sample: mitsuba.Float, active: mitsuba.Bool = True):
        """
        Projects a point on the surface of the shape to its silhouette as seen
        from a specified viewpoint.
    ...
    def ray_intersect(self: mitsuba.cuda_spectral.ShapePtr, ray: mitsuba.cuda_spectral.Ray3f, ray_flags: int = 14, active: mitsuba.Bool = True):
        """
        Test for an intersection and return detailed information
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_spectral.ShapePtr, ray: mitsuba.cuda_spectral.Ray3f, prim_index: int = 0, active: mitsuba.Bool = True):
        """
        Fast ray intersection
    ...
    def ray_test(self: mitsuba.cuda_spectral.ShapePtr, ray: mitsuba.cuda_spectral.Ray3f, active: mitsuba.Bool = True) -> mitsuba.Bool:
        """
        Fast ray shadow test
    ...
    def sample_direction(self: mitsuba.cuda_spectral.ShapePtr, it, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
        Sample a direction towards this shape with respect to solid angles
        measured at a reference position within the scene
    ...
    def sample_position(self: mitsuba.cuda_spectral.ShapePtr, time: mitsuba.Float, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True):
        """
        Sample a point on the surface of this shape
    ...
    def sample_precomputed_silhouette(self: mitsuba.cuda_spectral.ShapePtr, viewpoint: mitsuba.cuda_spectral.Point3f, sample1: mitsuba.UInt, sample2: mitsuba.Float, active: mitsuba.Bool = True):
        """
        Samples a boundary segement on the shape's silhouette using
        precomputed information computed in precompute_silhouette.
    ...
    def sample_silhouette(self: mitsuba.cuda_spectral.ShapePtr, sample: mitsuba.cuda_spectral.Point3f, flags: int, active: mitsuba.Bool = True):
        """
        Map a point sample in boundary sample space to a silhouette segment
    ...
    def sensor(self: mitsuba.cuda_spectral.ShapePtr):
        """
        Return the area sensor associated with this shape (if any)
        """
        ...

    def shape_type(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.UInt:
        """
        Returns the shape type ShapeType of this shape
        """
        ...

    def silhouette_discontinuity_types(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.UInt:
        """
        //! @{ \name Silhouette sampling routines and other utilities
        """
        ...

    def silhouette_sampling_weight(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.Float:
        """
        Return this shape's sampling weight w.r.t. all shapes in the scene
        """
        ...

    def surface_area(self: mitsuba.cuda_spectral.ShapePtr) -> mitsuba.Float:
        """
        Return the shape's surface area.
...
class SilhouetteSample3f(PositionSample3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SilhouetteSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SilhouetteSample3f, other: mitsuba.cuda_spectral.SilhouetteSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_spectral.SilhouetteSample3f, arg0: mitsuba.cuda_spectral.SilhouetteSample3f) -> None: ...
    def is_valid(self: mitsuba.cuda_spectral.SilhouetteSample3f) -> mitsuba.Bool:
        """
        Is the current boundary segment valid=
        """
        ...

    def spawn_ray(self: mitsuba.cuda_spectral.SilhouetteSample3f) -> mitsuba.cuda_spectral.Ray3f:
        """
...
class Spectrum:
    def __init__(self: mitsuba.cuda_spectral.Spectrum, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class SurfaceInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SurfaceInteraction3f, arg0: mitsuba.cuda_spectral.SurfaceInteraction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.SurfaceInteraction3f, ps, wavelengths: mitsuba.cuda_spectral.Spectrum) -> None:
        """
        Construct from a position sample. Unavailable fields such as `wi` and
        the partial derivatives are left uninitialized. The `shape` pointer is
        left uninitialized because we can't guarantee that the given
    ...
    def assign(self: mitsuba.cuda_spectral.SurfaceInteraction3f, arg0: mitsuba.cuda_spectral.SurfaceInteraction3f) -> None: ...
    @overload
    def bsdf(self: mitsuba.cuda_spectral.SurfaceInteraction3f, ray: mitsuba.cuda_spectral.RayDifferential3f):
        """
    ...
    @overload
    def bsdf(self: mitsuba.cuda_spectral.SurfaceInteraction3f): ...
    def compute_uv_partials(self: mitsuba.cuda_spectral.SurfaceInteraction3f, ray: mitsuba.cuda_spectral.RayDifferential3f) -> None:
        """
        Computes texture coordinate partials
        """
        ...

    def emitter(self: mitsuba.cuda_spectral.SurfaceInteraction3f, scene: mitsuba.cuda_spectral.Scene, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.EmitterPtr:
        """
    ...
    def has_n_partials(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> bool: ...
    def has_uv_partials(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> bool: ...
    def initialize_sh_frame(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> None:
        """
        Initialize local shading frame using Gram-schmidt orthogonalization
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> mitsuba.Bool:
        """
        Does the surface mark a transition between two media?
        """
        ...

    def is_sensor(self: mitsuba.cuda_spectral.SurfaceInteraction3f) -> mitsuba.Bool:
        """
    ...
    @overload
    def target_medium(self: mitsuba.cuda_spectral.SurfaceInteraction3f, d: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.MediumPtr:
        """
    ...
    @overload
    def target_medium(self: mitsuba.cuda_spectral.SurfaceInteraction3f, cos_theta: mitsuba.Float) -> mitsuba.cuda_spectral.MediumPtr:
        """
    ...
    def to_local(self: mitsuba.cuda_spectral.SurfaceInteraction3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Convert a world-space vector into local shading coordinates
        """
        ...

    def to_local_mueller(self: mitsuba.cuda_spectral.SurfaceInteraction3f, M_world: mitsuba.cuda_spectral.Spectrum, wi_world: mitsuba.cuda_spectral.Vector3f, wo_world: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def to_world(self: mitsuba.cuda_spectral.SurfaceInteraction3f, v: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
        """
        Convert a local shading-space vector into world space
        """
        ...

    def to_world_mueller(self: mitsuba.cuda_spectral.SurfaceInteraction3f, M_local: mitsuba.cuda_spectral.Spectrum, wi_local: mitsuba.cuda_spectral.Vector3f, wo_local: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Spectrum:
        """
...
class Texture(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.Texture, props: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def eval(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_1(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
    ...
    def eval_1_grad(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Vector2f:
        """
    ...
    def eval_3(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
        """
    ...
    def is_spatially_varying(self: mitsuba.cuda_spectral.Texture) -> bool:
        """
        Does this texture evaluation depend on the UV coordinates
        """
        ...

    def max(self: mitsuba.cuda_spectral.Texture) -> float:
        """
    ...
    def mean(self: mitsuba.cuda_spectral.Texture) -> mitsuba.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_spectral.Texture, p: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Returns the probability per unit area of sample_position()
        """
        ...

    def pdf_spectrum(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def resolution(self: mitsuba.cuda_spectral.Texture) -> mitsuba.Vector2i:
        """
    ...
    def sample_position(self: mitsuba.cuda_spectral.Texture, sample: mitsuba.cuda_spectral.Point2f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Point2f, mitsuba.Float]:
        """
    ...
    def sample_spectrum(self: mitsuba.cuda_spectral.Texture, si: mitsuba.cuda_spectral.SurfaceInteraction3f, sample: mitsuba.cuda_spectral.Spectrum, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
        """
    ...
    def spectral_resolution(self: mitsuba.cuda_spectral.Texture) -> float:
        """
    ...
    def wavelength_range(self: mitsuba.cuda_spectral.Texture) -> mitsuba.Vector2f:
        """
...
class Transform3d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: mitsuba.cuda_spectral.Transform3d) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: mitsuba.Matrix3f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: mitsuba.Matrix3f64, arg1: mitsuba.Matrix3f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3d, arg0: mitsuba.Transform3d) -> None:
        """
...
class Transform3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: mitsuba.cuda_spectral.Transform3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: mitsuba.Matrix3f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: mitsuba.Matrix3f, arg1: mitsuba.Matrix3f) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform3f, arg0: mitsuba.Transform3f) -> None:
        """
        Broadcast constructor
        """
        ...
...
class Transform4d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: mitsuba.cuda_spectral.Transform4d) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: mitsuba.Matrix4f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: mitsuba.Matrix4f64, arg1: mitsuba.Matrix4f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4d, arg0: mitsuba.Transform4d) -> None:
        """
        Broadcast constructor
        """
        ...
...
class Transform4f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: mitsuba.cuda_spectral.Transform4f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: mitsuba.Matrix4f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: mitsuba.Matrix4f, arg1: mitsuba.Matrix4f) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.Transform4f, arg0: mitsuba.Transform4f) -> None:
        """
        Broadcast constructor
        """
        ...
...
class UInt:
    ...
    @overload
    def __init__(self: mitsuba.UInt, arg0) -> None: ...
    @overload
...
class UInt64:
    ...
    @overload
    def __init__(self: mitsuba.UInt64, arg0) -> None: ...
    @overload
...
class Vector0d:
    def __init__(self: mitsuba.cuda_spectral.Vector0d, *args) -> None: ...
    label = ...
...
class Vector0f:
    def __init__(self: mitsuba.cuda_spectral.Vector0f, *args) -> None: ...
    label = ...
...
class Vector0i:
    def __init__(self: mitsuba.cuda_spectral.Vector0i, *args) -> None: ...
    label = ...
...
class Vector0u:
    def __init__(self: mitsuba.cuda_spectral.Vector0u, *args) -> None: ...
    label = ...
...
class Vector1d:
    def __init__(self: mitsuba.cuda_spectral.Vector1d, *args) -> None: ...
    label = ...
    x = ...
...
class Vector1f:
    def __init__(self: mitsuba.cuda_spectral.Vector1f, *args) -> None: ...
    label = ...
    x = ...
...
class Vector1i:
    def __init__(self: mitsuba.cuda_spectral.Vector1i, *args) -> None: ...
    label = ...
    x = ...
...
class Vector1u:
    def __init__(self: mitsuba.cuda_spectral.Vector1u, *args) -> None: ...
    label = ...
    x = ...
...
class Vector2d:
    def __init__(self: mitsuba.cuda_spectral.Vector2d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Vector2f:
    def __init__(self: mitsuba.cuda_spectral.Vector2f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Vector2i:
    def __init__(self: mitsuba.cuda_spectral.Vector2i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Vector2u:
    def __init__(self: mitsuba.cuda_spectral.Vector2u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Vector3d:
    def __init__(self: mitsuba.cuda_spectral.Vector3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Vector3f:
    def __init__(self: mitsuba.cuda_spectral.Vector3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Vector3i:
    def __init__(self: mitsuba.cuda_spectral.Vector3i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Vector3u:
    def __init__(self: mitsuba.cuda_spectral.Vector3u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Vector4d:
    def __init__(self: mitsuba.cuda_spectral.Vector4d, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Vector4f:
    def __init__(self: mitsuba.cuda_spectral.Vector4f, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Vector4i:
    def __init__(self: mitsuba.cuda_spectral.Vector4i, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Vector4u:
    def __init__(self: mitsuba.cuda_spectral.Vector4u, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Volume(Object):
    ...
    def __init__(self: mitsuba.cuda_spectral.Volume, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def bbox(self: mitsuba.cuda_spectral.Volume) -> mitsuba.BoundingBox3f:
        """
        Returns the bounding box of the volume
        """
        ...

    def channel_count(self: mitsuba.cuda_spectral.Volume) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Spectrum:
        """
    ...
    def eval_1(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.Float:
        """
        Evaluate this volume as a single-channel quantity.
        """
        ...

    def eval_3(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Vector3f:
        """
    ...
    def eval_6(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> List[mitsuba.Float[6]]:
        """
    ...
    def eval_gradient(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Vector3f]:
        """
    ...
    def eval_n(self: mitsuba.cuda_spectral.Volume, it: mitsuba.cuda_spectral.Interaction3f, active: mitsuba.Bool = True) -> List[mitsuba.Float]:
        """
    ...
    def max(self: mitsuba.cuda_spectral.Volume) -> float:
        """
        Returns the maximum value of the volume over all dimensions.
        """
        ...

    def max_per_channel(self: mitsuba.cuda_spectral.Volume) -> List[float]:
        """
    ...
    def resolution(self: mitsuba.cuda_spectral.Volume) -> mitsuba.Vector3i:
        """
...
class VolumeGrid(Object):
    @overload
    def __init__(self: mitsuba.cuda_spectral.VolumeGrid, array: numpy.ndarray[numpy.float32], compute_max: bool = True) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.VolumeGrid, path: mitsuba.filesystem.path) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_spectral.VolumeGrid, stream: mitsuba.Stream) -> None: ...
    ptr = ...

    def buffer_size(self: mitsuba.cuda_spectral.VolumeGrid) -> int:
        """
        Return the volume grid size in bytes (excluding metadata)
        """
        ...

    def bytes_per_voxel(self: mitsuba.cuda_spectral.VolumeGrid) -> int:
        """
        Return the number bytes of storage used per voxel
        """
        ...

    def channel_count(self: mitsuba.cuda_spectral.VolumeGrid) -> int:
        """
    ...
    def max(self: mitsuba.cuda_spectral.VolumeGrid) -> float:
        """
        Return the precomputed maximum over the volume grid
        """
        ...

    def max_per_channel(self: mitsuba.cuda_spectral.VolumeGrid) -> List[float]:
        """
    ...
    def set_max(self: mitsuba.cuda_spectral.VolumeGrid, arg0: float) -> None:
        """
        Set the precomputed maximum over the volume grid
        """
        ...

    def set_max_per_channel(self: mitsuba.cuda_spectral.VolumeGrid, arg0: List[float]) -> None:
        """
    ...
    def size(self: mitsuba.cuda_spectral.VolumeGrid) -> mitsuba.Vector3u:
        """
    ...
    @overload
    def write(self: mitsuba.cuda_spectral.VolumeGrid, stream: mitsuba.Stream) -> None:
        """
    ...
    @overload
    def write(self: mitsuba.cuda_spectral.VolumeGrid, path: mitsuba.filesystem.path) -> None:
        """
...
def cie1931_xyz(wavelength: mitsuba.Float) -> mitsuba.cuda_spectral.Color3f:
    """
...
def coordinate_system(n: mitsuba.cuda_spectral.Vector3f) -> Tuple[mitsuba.cuda_spectral.Vector3f, mitsuba.cuda_spectral.Vector3f]:
    """
...
def depolarizer(arg0: mitsuba.cuda_spectral.Spectrum) -> mitsuba.cuda_spectral.Spectrum: ...
def eval_reflectance(type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, wi: mitsuba.cuda_spectral.Vector3f, eta: float) -> mitsuba.Float: ...
...
def linear_rgb_rec(wavelength: mitsuba.Float) -> mitsuba.cuda_spectral.Color3f:
    """
...
@overload
def luminance(value: mitsuba.cuda_spectral.Spectrum, wavelengths: mitsuba.cuda_spectral.Spectrum, active: mitsuba.Bool = True) -> mitsuba.Float: ...
@overload
def luminance(c: mitsuba.cuda_spectral.Color3f) -> mitsuba.Float: ...

from . import python_math as math


from . import cuda_spectral_mueller as mueller
...
@overload
def pdf_rgb_spectrum(wavelengths: mitsuba.cuda_spectral.Spectrum) -> mitsuba.cuda_spectral.Spectrum:
    """
    PDF for the sample_rgb_spectrum strategy. It is valid to call this
    function for a single wavelength (Float), a set of wavelengths
    (Spectrumf), a packet of wavelengths (SpectrumfP), etc. In all cases,
...
def perspective_projection(film_size: mitsuba.Vector2i, crop_size: mitsuba.Vector2i, crop_offset: mitsuba.Vector2i, fov_x: mitsuba.Float, near_clip: mitsuba.Float, far_clip: mitsuba.Float) -> mitsuba.cuda_spectral.Transform4f:
    """
...
from . import cuda_spectral_quad as quad
...
@overload
def reflect(wi: mitsuba.cuda_spectral.Vector3f) -> mitsuba.cuda_spectral.Vector3f:
    """
...
@overload
def reflect(wi: mitsuba.cuda_spectral.Vector3f, m: mitsuba.cuda_spectral.Normal3f) -> mitsuba.cuda_spectral.Vector3f:
    """
...
@overload
def refract(wi: mitsuba.cuda_spectral.Vector3f, cos_theta_t: mitsuba.Float, eta_ti: mitsuba.Float) -> mitsuba.cuda_spectral.Vector3f:
    """
...
@overload
def refract(wi: mitsuba.cuda_spectral.Vector3f, m: mitsuba.cuda_spectral.Normal3f, cos_theta_t: mitsuba.Float, eta_ti: mitsuba.Float) -> mitsuba.cuda_spectral.Vector3f:
    """
...
@overload
def sample_rgb_spectrum(sample: mitsuba.cuda_spectral.Spectrum) -> Tuple[mitsuba.cuda_spectral.Spectrum, mitsuba.cuda_spectral.Spectrum]:
    """
    Importance sample a "importance spectrum" that concentrates the
    computation on wavelengths that are relevant for rendering of RGB data
...
def sggx_pdf(wm: mitsuba.cuda_spectral.Vector3f, s) -> mitsuba.Float:
    """
...
def sggx_projected_area(wi: mitsuba.cuda_spectral.Vector3f, s) -> mitsuba.Float:
    """
...
@overload
def sggx_sample(sh_frame: mitsuba.cuda_spectral.Frame3f, sample: mitsuba.cuda_spectral.Point2f, s) -> mitsuba.cuda_spectral.Normal3f:
    """
...
@overload
def sggx_sample(sh_frame: mitsuba.cuda_spectral.Vector3f, sample: mitsuba.cuda_spectral.Point2f, s) -> mitsuba.cuda_spectral.Normal3f:
    """
    Samples the visible normal distribution of the SGGX microflake
    distribution
...
def spectrum_to_srgb(value: mitsuba.cuda_spectral.Spectrum, wavelengths: mitsuba.cuda_spectral.Spectrum, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
    """
...
def spectrum_to_xyz(value: mitsuba.cuda_spectral.Spectrum, wavelengths: mitsuba.cuda_spectral.Spectrum, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
    """
...
from . import cuda_spectral_spline as spline

def srgb_model_eval(arg0: mitsuba.Array3f, arg1: mitsuba.cuda_spectral.Spectrum) -> mitsuba.cuda_spectral.Spectrum: ...
...
def srgb_to_xyz(rgb: mitsuba.cuda_spectral.Color3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
    """
...
def unpolarized_spectrum(arg0: mitsuba.cuda_spectral.Spectrum) -> mitsuba.cuda_spectral.Spectrum: ...
...
from . import cuda_spectral_warp as warp
...
def xyz_to_srgb(rgb: mitsuba.cuda_spectral.Color3f, active: mitsuba.Bool = True) -> mitsuba.cuda_spectral.Color3f:
    """
