...
if __name__ == "__main__":
    cg = CrownGenerator()
    cg.num_of_leaves = 10000
    cg.crown_diameter_EW = 2
    cg.crown_diameter_SN = 2
    cg.crown_height = 4
    cg.crown_shape = CrownShape.ELLIPSOID
    cg.leaf_angle_dist = LAD.SPHERICAL
    cg.single_leaf_area = 0.001
    cg.leaf_shape = LeafShape.SQUARE
    cg.has_trunk = True
    cg.generate_crown(r"D:\crown.obj")