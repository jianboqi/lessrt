...
struct TSpectrum_to_Spectrum {
	static PyObject* convert(const TSpectrum<Float> &spectrum) {
...
static Spectrum *spectrum_array_constructor(bp::list list) {
	...
	std::vector<Float> spec = std::vector<Float>(SPECTRUM_SAMPLES);
...
void export_core() {
	...
	bp::to_python_converter<TSpectrum<Float>, TSpectrum_to_Spectrum>();
