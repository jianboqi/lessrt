 ...
 * \ingroup libhw
 */
class MTS_EXPORT_RENDER SpectrumAdditionTexture : public Texture {
public:
 ...
 * \ingroup libhw
 */
class MTS_EXPORT_RENDER SpectrumSubtractionTexture : public Texture {
public:
 ...
 * \ingroup libhw
 */
class MTS_EXPORT_RENDER SpectrumProductTexture : public Texture {
public:
